...
bool MediaPlayer::playFile(QString file) {
   // if(libvlc_media_player_will_play(_mp, &_vlcexcep)){
    ...
    _m = libvlc_media_new_location(_vlcinstance, file.toAscii()/*, &_vlcexcep*/);
    //raise(&_vlcexcep);
